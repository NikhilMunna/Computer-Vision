# USAGE
# python face_detect_videos.py --prototxt deploy.prototxt.txt --model res10_300x300_ssd_iter_140000.caffemodel
...
if __name__ == "__main__":
    ...
    face_detect = DetectFromVideo(args)
    face_detect.detect_from_video()